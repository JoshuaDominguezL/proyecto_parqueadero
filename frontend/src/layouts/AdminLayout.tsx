...
import { 
  ...
  LogOut,
  Database, Menu, FileText, Sun, Moon
} from 'lucide-react';
        ...
        <header className="h-24 bg-white dark:bg-[#121212]/80 dark:backdrop-blur-xl border-b border-gray-100 dark:border-white/5 flex items-center justify-between px-6 lg:px-10 z-40 shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-colors duration-500">
          <div className="flex items-center gap-6">
            <button 
              ...
              className="w-12 h-12 flex items-center justify-center rounded-2xl bg-[#F8FAFC] dark:bg-white/5 text-gray-400 hover:bg-[#39A900]/10 hover:text-[#39A900] transition-all duration-300 border border-gray-100 dark:border-white/10 group"
